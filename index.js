...
io.on('connection', (socket) => {
  ...
  socket.on('chat message', (msg) => {
    ...
    if (msg.substring(0, 5) === '!HELP') { //  Check for '!HELP' command
      ...
      const msgtext = `<i style="color:${users[userIndex][2]}">${username}:</i><marquee behavior="scroll" direction="left" scrollamount="30"><img src="/rsrc/yoshi.png" width="32" height="32" alt="Flying Bat"></marquee>`;
      io.emit('chat message', msgtext);
      chatlog.push(msgtext);
